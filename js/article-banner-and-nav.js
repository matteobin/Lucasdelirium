document.getElementById('style').insertAdjacentHTML('beforeend', ".container a.nav{display:none}@media only screen and (min-width:45em){.container a.nav{display:block;margin-top:5em}.container.row article{width:83.33%}}");
